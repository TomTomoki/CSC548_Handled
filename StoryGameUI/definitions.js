...
function nextStory (stories, index){
    ...
    if(index < stories.length){
        ...
        $("#frame")[0].textContent = "Thank you for completing this short story! Taking after Handled’s focus on mental health, the main emphasis of these scenarios were to reveal the stressful situations that arise during one’s college career." +
